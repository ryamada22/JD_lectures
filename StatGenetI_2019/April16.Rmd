...
\int_0^1  \frac{\Gamma(\alpha+\beta)}{\Gamma(\alpha) \Gamma(\beta)!} p_1^\alpha \times p_2^\beta d p_1 =1\\

$$
## Beta distribution

$$
\frac{\Gamma(\alpha+\beta)}{\Gamma(\alpha) \Gamma(\beta)!} p_1^\alpha \times p_2^\beta
$$
